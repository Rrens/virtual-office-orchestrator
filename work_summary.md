...
| 2026-09-26 | Session 30 (Semi-Transparent Entrance Glass Doors & Lobby Facade Refinement) | Refined front entrance sliding doors at z = 18 to high-clarity semi-transparent architectural glass (opacity: 0.55, roughness: 0.02) with slender black aluminium perimeter sashes and stainless steel pull handles, replacing solid black frames so that receptionist counter, turnstiles, and ground lobby interior are clearly visible from outside |
...
| 2026-09-26 | ADR-028: Semi-Transparent Entrance Portal & Lobby Interior Transparency | Mengganti solid black frame pintu lobi depan dengan kaca semi-transparan (opacity: 0.55) dan profil sash ramping sehingga seluruh elemen interior lobi lantai 1 (meja resepsionis Siti, turnstile Pak Joko) terlihat jernih dari luar fasad gedung |
